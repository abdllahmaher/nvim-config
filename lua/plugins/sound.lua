...
local FALLBACK_SOUNDS = {
  "KeyA.ogg", "KeyB.ogg", "KeyC.ogg", "KeyD.ogg", "KeyE.ogg",
  "KeyF.ogg", "KeyG.ogg", "KeyH.ogg", "KeyI.ogg", "KeyJ.ogg",
  "KeyK.ogg", "KeyL.ogg", "KeyM.ogg", "KeyN.ogg", "KeyO.ogg",
  "KeyP.ogg", "KeyQ.ogg", "KeyR.ogg", "KeyS.ogg", "KeyT.ogg",
}
...
local CHAR_TO_SOUND = {
  -- Letters
  a="KeyA.ogg", b="KeyB.ogg", c="KeyC.ogg", d="KeyD.ogg", e="KeyE.ogg",
  f="KeyF.ogg", g="KeyG.ogg", h="KeyH.ogg", i="KeyI.ogg", j="KeyJ.ogg",
  k="KeyK.ogg", l="KeyL.ogg", m="KeyM.ogg", n="KeyN.ogg", o="KeyO.ogg",
  p="KeyP.ogg", q="KeyQ.ogg", r="KeyR.ogg", s="KeyS.ogg", t="KeyT.ogg",
  u="KeyU.ogg", v="KeyV.ogg", w="KeyW.ogg", x="KeyX.ogg", y="KeyY.ogg",
  z="KeyZ.ogg",
  A="KeyA.ogg", B="KeyB.ogg", C="KeyC.ogg", D="KeyD.ogg", E="KeyE.ogg",
  F="KeyF.ogg", G="KeyG.ogg", H="KeyH.ogg", I="KeyI.ogg", J="KeyJ.ogg",
  K="KeyK.ogg", L="KeyL.ogg", M="KeyM.ogg", N="KeyN.ogg", O="KeyO.ogg",
  ...
  -- Digits
  ["0"]="Digit0.ogg", ["1"]="Digit1.ogg", ["2"]="Digit2.ogg",
  ["3"]="Digit3.ogg", ["4"]="Digit4.ogg", ["5"]="Digit5.ogg",
  ["6"]="Digit6.ogg", ["7"]="Digit7.ogg", ["8"]="Digit8.ogg",
  ["9"]="Digit9.ogg",

  -- Shifted digit row
  ["!"]="Digit1.ogg", ["@"]="Digit2.ogg", ["#"]="Digit3.ogg",
  ["$"]="Digit4.ogg", ["%"]="Digit5.ogg", ["^"]="Digit6.ogg",
  ["&"]="Digit7.ogg", ["*"]="Digit8.ogg", ["("]="Digit9.ogg",
  [")"]="Digit0.ogg",
  ...
  -- Punctuation
  ["`"]="Backquote.ogg", ["~"]="Backquote.ogg",
  ["-"]="Minus.ogg",     ["_"]="Minus.ogg",
  ["="]="Equal.ogg",     ["+"]="Equal.ogg",
  ["["]="BracketLeft.ogg",  ["{"]="BracketLeft.ogg",
  ["]"]="BracketRight.ogg", ["}"]="BracketRight.ogg",
  ["\\"]="Backslash.ogg",   ["|"]="Backslash.ogg",
  [";"]="Semicolon.ogg",    [":"]="Semicolon.ogg",
  ["'"]="Quote.ogg",        ['"']="Quote.ogg",
  [","]="Comma.ogg",        ["<"]="Comma.ogg",
  ["."]="Period.ogg",       [">"]="Period.ogg",
  ["/"]="Slash.ogg",        ["?"]="Slash.ogg",
}

-- ── Debounce state ───────────────────────────────────────────────────────────
local MIN_INTERVAL_MS = 30
...
function M.on_insert_char()
  ...
  if (now - last_played_ms) < MIN_INTERVAL_MS then return end
  last_played_ms = now

  local char  = vim.v.char
  local sound = CHAR_TO_SOUND[char]
             or FALLBACK_SOUNDS[math.random(#FALLBACK_SOUNDS)]
  play(sound)
end
...
function M.on_mode_changed()
  ...
  if     new == "i" or new == "ic" then play("Tab.ogg")
  elseif new == "n"                then play("Escape.ogg")
  elseif new == "v" or new == "V"
      or new == "\22"              then play("CapsLock.ogg")
  elseif new == "c"                then play("Enter.ogg")
  end
end
...
return {
  {
    ...
    keys = {
      { "<leader>st", function() vim.cmd("BeepBoopToggle") end,     desc = "Sound: toggle" },
      { "<leader>s+", function() vim.cmd("BeepBoopVolume +10") end, desc = "Sound: volume up" },
      { "<leader>s-", function() vim.cmd("BeepBoopVolume -10") end, desc = "Sound: volume down" },
    },
  },
}
